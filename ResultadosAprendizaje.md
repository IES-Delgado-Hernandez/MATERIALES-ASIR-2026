...
- **e)** Se han previsto los recursos materiales y personales necesarios para realizar el proyecto.  
...
**Planifica la puesta en funcionamiento o ejecución del proyecto, determinando el plan de intervención y la documentación asociada.**
